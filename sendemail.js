...
const pool = new Pool({
  ...
  const sender = AccountAddress.fromBase58('4rU8pSVm3dCqxgbDQjWDboTE6EegyWo43dAbQeyCtQw5NQUqF5');
  ...
  const contractAddress = ContractAddress.create(9571, 0);
						...
						<table border="0" cellpadding="0" cellspacing="0" style="border-collapse:separate; min-height:515px; min-width:100%; mso-table-lspace:0pt; mso-table-rspace:0pt; width:100%">
							<tbody>
								<tr>
									...
									<p style="margin-left:0px; margin-right:0px; text-align:center">Own a part of a song that has reached the Top 20 of Djooky Awards</p>
									<p style="margin-left:0px; margin-right:0px; text-align:center">Kler'sauction now live, starting at 0.22 Euro per right. </p>
